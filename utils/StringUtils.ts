 ...
 * @Last Modified time: 2021-01-05 14:41:51
 */
export default class StringUtils extends Singleton {
    ...
    public getQueryString(key: string) {
        const query = sdk.getInstance().getQuery() || {};
        let ret = query[key];
     ...
     * @param num
     */
    public getNumberToStr(num: number): string {
